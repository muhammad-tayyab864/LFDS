...
class stereoColorTransferDataset(Dataset):
    def __init__(self,root,transform):
        self.transform = transform
        self.imgs_path = root
        self.data = []
        ...
        for i in range(len(self.imgs_path)):
            self.data_list_L = []
            self.data_list_R = []
            file_list_L = glob.glob(self.imgs_path[i] + "/**/*view1.png",recursive=True)
            file_list_R = glob.glob(self.imgs_path[i] + "/**/*view5.png",recursive=True) 
